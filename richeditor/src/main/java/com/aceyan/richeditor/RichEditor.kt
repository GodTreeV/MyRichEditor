...
import com.aceyan.richeditor.Utils.currentTime
import com.aceyan.richeditor.Utils.decodeResource
import com.aceyan.richeditor.Utils.toBase64
import com.aceyan.richeditor.Utils.toBitmap
import java.io.UnsupportedEncodingException
import java.net.URLEncoder

@SuppressLint("SetJavaScriptEnabled")
open class RichEditor @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet?,
    ...
    companion object {
        ...
        const val LOCAL_FILE_HEADER = "file://"
    }

    enum class Type {
        BOLD, ITALIC, SUBSCRIPT, SUPERSCRIPT, STRIKETHROUGH, UNDERLINE, H1, H2, H3, H4, H5, H6,
        ORDEREDLIST, UNORDEREDLIST, JUSTIFYCENTER, JUSTIFYFULL, JUSTIFYLEFT, JUSTIFYRIGHT
    }
    ...
    fun setFontSize(fontSize: Int) {
        if (fontSize > 7 || fontSize < 1) {
            throw IllegalArgumentException("Font size should have a value between 1-7")
        }
     ...
     *
     * If you want to insert image from local, please use format like:
     * file://${your local image file path}, eg. insertImage("file:///sdcard/Pictures/image.png")
     *
     * @see [LOCAL_FILE_HEADER]
     *
     * @param url
     * @param alt
     * @param width
